...
#adjacentes<-function(grafo,entorno,nodo){
#    for (i in entorno) {
#        listita<-are_adjacent(grafo,i,nodo)
#    }
#    return(listita)
#}

#adjacentes2 <- function(grafo,entorno,nodo){
#    salida <- sapply(entorno, function(x) are_adjacent(grafo,x,nodo))
#    return(salida)
#}


net <- make_full_graph(100)
...
neighbourhoodNet <- neighbourhoodNet[[1]]
k <-
  ego_size(
    net,
    order = 1,
