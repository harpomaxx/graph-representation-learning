...
```{r}
tati_data<-readr::read_csv("./all_captures_except_9_SINnormalizar_pkts.csv")
harpo_data2<-readr::read_csv("./all_but_capture9-lcc-non-directed.csv")
harpo_data<-readr::read_csv("./all_but_capture9.csv")
